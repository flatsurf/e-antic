...
int test_field1()
{
	...
	for(iter=1; iter<2000; iter++)
	{
		...
		if(check_ceil(a,nf,1-iter%2,"sqrt(5)")) {TEST_CEIL_CLEANUP; return 1;}
	}

	{TEST_CEIL_CLEANUP; return 0;}
}
...
int test_field2()
{
	...
	if(check_ceil(a, nf, 2, "3^(1/4)")) {TEST_CEIL_CLEANUP; return 1;}
	...
	if(check_ceil(a, nf, 1, "3^(1/4)")) {TEST_CEIL_CLEANUP; return 1;}
	...
	if(check_ceil(a, nf, 0, "3^(1/4)")) {TEST_CEIL_CLEANUP; return 1;}
	...
	if(check_ceil(a, nf, 231, "3^(1/4)")) {TEST_CEIL_CLEANUP; return 1;}
