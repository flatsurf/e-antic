...
main(void)
{
    ...
    for (i = 0; i < 100; i++)
    {
        ...
        fmpz_poly_init(h);
        fmpz_poly_init(p);
        fmpz_poly_randtest(f, state, (slong)n_randint(state, 50), 100);
        fmpz_poly_randtest(g, state, (slong)n_randint(state, 50), 100);
        fmpz_poly_randtest(h, state, (slong)n_randint(state, 50), 100);
